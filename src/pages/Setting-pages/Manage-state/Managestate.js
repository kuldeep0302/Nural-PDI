...
const Managestate = () => {
  ...
  return (
    <div className="Managestate-container">
      <div className="fistline-Managestate">
        <p className="name-Managestate">
          <span>
      ...
      <div className="autocompleteform-Managestate">
        <div className="name2-Managestate">
          <p>Manage State</p>{" "}
        </div>

        <div className="textinputmain-Managestate">
          ...
          <div className="button-Managestate">
            <button
              className="CANCEL-Managestate"
              type="button"
              onClick={() => {
                history("/Managestatemain");
              }}
            >
              CANCEL
            </button>
