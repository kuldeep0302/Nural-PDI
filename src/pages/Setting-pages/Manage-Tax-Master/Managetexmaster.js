...
const Managetexmaster = () => {
  ...
  return (
    <div className="Managetexmaster-container">
      <div className="fistline-Managetexmaster">
        <p className="name-Managetexmaster">
          <span>
            <Link to="/Managetexmaster">Manage Tax Master</Link> &gt;
          </span>
          <span>
            {" "}
            <Link to="#">Add</Link>{" "}
      ...
      <div className="autocompleteform-Managetexmaster">
        <div className="namewithicone-Managetexmaster">
          <p className="name2-Managetexmaster">
            <p>Manage Tax Master</p>
          </p>
        </div>
        <div className="textbox-main-Managetexmaster">
          ...
          <div className="button-Managetexmaster">
            {" "}
            <button
              className="CANCEL-Managetexmaster"
              type="button"
              onClick={() => {
                history("/Managelocalitymain");
              }}
            >
              CANCEL
            </button>
            <button
              id="save-button"
              className="Save-Managetexmaster"
              type="button"
              onClick={handleClick}
            >
              SAVE
