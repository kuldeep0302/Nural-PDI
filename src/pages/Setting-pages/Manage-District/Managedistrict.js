  ...
  return (
    <div className="Managedistrict-container">
      <div className="fistline-Managedistrict">
        <p className="name-Managedistrict">
          <span>
      ...
      <div className="autocompleteform-Managedistrict">
        <div className="name2-Managedistrict">
          <p>Manage District</p>{" "}
        </div>
        ...
        <div className="textinputmain-Managedistrict">
          ...
          <div className="line-Managedistrict">
            ...
            <div className="textinput-Managedistrict"></div>
          </div>
        </div>

        <div className="button-Managedistrict">
          {" "}
          <button
            className="CANCEL-Managedistrict"
            type="button"
            onClick={() => {
              history("/Managedistrictmain");
            }}
          >
            CANCEL
          </button>
